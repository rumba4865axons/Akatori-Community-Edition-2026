...
# 🎮 Akatori — Community Edition

**Akatori — standalone Community Edition, ready to play offline.**
...
Akatori is an anime-inspired action adventure game in which a young heroine, accompanied by her red bird companion, journeys across a hand-crafted fantasy world filled with aerial traversal, exploration, and combat. This Community Edition is a standalone build distributed as a self-contained package. It requires no storefront or additional software and is ready to play immediately after installation.

Players who want a complete, offline, single-player action adventure experience on Windows without a storefront account.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1442520/c3290902978f8ce290d2243d3030207fb0b3f7f3/ss_c3290902978f8ce290d2243d3030207fb0b3f7f3.1920x1080.jpg?t=1786474932" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1442520/b9e0c786819448797af5f8a62f9f18e7c41fa5a5/ss_b9e0c786819448797af5f8a62f9f18e7c41fa5a5.1920x1080.jpg?t=1786474932" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1442520/033c3922c863bc8e9713be498a83073b25da290e/ss_033c3922c863bc8e9713be498a83073b25da290e.1920x1080.jpg?t=1786474932" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ✅ **No Steam, PlayStation Store / Microsoft Store account required**
...
- **Interface:** English, Japanese, French, German, Spanish, Simplified Chinese, Traditional Chinese, Korean
...
- 🦜 **Bird Companion Traversal** — Glide, dive, and soar through open skies alongside your red bird companion.
- 🗺️ **Hand-Crafted World** — Explore a fully realized fantasy realm with distinct regions, ruins, and sky islands.
- ⚔️ **Dynamic Action Combat** — Fast-paced melee combat with dodge timing, combos, and aerial attacks.
- 🎨 **Anime Art Direction** — Stylized visuals with vibrant environments and expressive character design.
- 🧩 **Environmental Puzzles** — Solve wind, light, and movement-based puzzles woven into the world.
- 📖 **Story-Driven Adventure** — A narrative journey of friendship, loss, and discovery told through quests and dialogue.
- 🎵 **Original Soundtrack** — Atmospheric score that accompanies exploration and key story moments.
- 🛠️ **Community Modding Friendly** — Standalone structure supports community tweaks and fan modifications.
- 💾 **Self-Contained Package** — All game data ships in a single offline installer — no network access needed.
- 🖥️ **Runs on Standard PC Hardware** — Scales across mid-range and older Windows 10/11 systems.

- **Compression:** Lossless
- **Install Time:** ~5 minutes on SSD, ~12 minutes on HDD
- **Recoding:** none
- **Selective Download:** Full package only — single self-contained installer

---

## 📦 DLCs Included

- Base game — all released content included
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1060 6GB or AMD Radeon RX 580 | NVIDIA GeForce RTX 2060 or AMD Radeon RX 5600 XT |
| **Storage** | 15 GB available space | 20 GB available space on SSD |
| **Additional** | DirectX 12 compatible system | DirectX 12, SSD strongly recommended |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Akatori\Saved`
